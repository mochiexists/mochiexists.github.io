...
If the external target depends on a specific Git account, author identity, or human-only publish permission, name that in the spec and verify whether the authorized publish step actually happened.
